...
export default function UpdateProfile({ guest, children }) {
  ...
  return (
    <>
      <form
        action={updateGuest}
        className="bg-primary-900 py-8 px-12 text-lg flex gap-6 flex-col rounded-lg shadow-md shadow-zinc-800"
      >
...
function Button() {
  ...
  return (
   ...
   hover:bg-accent-600 transition-all disabled:cursor-not-allowed
    disabled:bg-gray-500 rounded-lg disabled:text-gray-300"
    >
